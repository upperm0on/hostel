...
room_info.addEventListener("click", () => {
        ...
        // Event listener for the amenity button to open the modal
...
submit_btn.addEventListener("click", (e) => {
    ...
    const infos = document.querySelectorAll(".add_info_item_here");
    const hidden_infos_input = document.querySelector(".hidden_info_data");
